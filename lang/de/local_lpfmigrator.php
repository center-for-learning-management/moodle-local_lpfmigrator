...
$string['notify_admins:text'] = '<strong><i>Liebe/r {$a->firstname} {$a->lastname},</i></strong> <br /><br />Sie erhalten diese e-Mail, weil Sie als Administrator/in der Moodle-Instanz unter <i>lernplattform.schule.at/<strong>{$a->instancename}</strong></i> eingetragen sind.<br /><br /><strong>Das Projekt lernplattform.schule.at wird zugunsten des Nachfolgeprojekts <a href="https://www.eduvidual.at" target="_blank">eduvidual.at</a> aufgelassen.</strong><br /><br />Bitte nehmen Sie zur Kenntnis, dass Ihre Moodle-Instanz deshalb nach individueller Absprache mit einem/r Moodle-Administrator/in dieser Instanz, spätestens jedoch am 19. Juli 2021, abgeschaltet wird. Wir werden einen Informationbalken in Ihrer Moodle-Seite anzeigen, damit alle Nutzer/innen über diesen Umstand informiert sind. Mit Beginn der Sommerferien wird die Moodle-Instanz zuerst in einen Wartungsmodus versetzt. Anschließend werden automatische Kursbackups angelegt, auf die Sie in weiterer Folge Zugriff erhalten.<br /><br />Wir empfehlen die Zeit bis dahin zu nutzen, um sich in der <strong>neuen, gemeinsamen Moodle-Lernplattform <a href="https://www.eduvidual.at" target="_blank">eduvidual.at</a> zu registrieren und einzurichten.</strong><br /><br />Mehr Informationen finden Sie auf unserer Webseite unter <a href="https://www.lernmanagement.at" target="_blank">lernmanagement.at</a> bzw. in unsererm  <a href="https://www.eduvidual.at/course/view.php?id=606&section=3" target="_blank">Supportbereich</a>, und natürlich helfen wir auch gerne per e-Mail unter <a href="mailto:support@lernmanagement.at">support@lernmanagement.at</a> weiter.<br /><br />Mit freundlichen Grüßen<br /><br />Ihr Team vom<br />Zentrum für Lernmanagement';

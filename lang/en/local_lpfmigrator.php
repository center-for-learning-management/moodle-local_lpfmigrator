...
$string['instance_remove_now'] = 'Remove instance';
...
$string['stage_2'] = 'Enable Maintenance mode';
$string['stage_3'] = 'Enable Backups';
$string['stage_4'] = 'Perform Review';
$string['stage_5'] = 'Command Removal';
$string['stage_6'] = 'Mark as Archived';
